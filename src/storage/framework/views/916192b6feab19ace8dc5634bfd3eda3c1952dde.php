			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<div class="fh5co-card-item">
						<a href="javascript:void(0)" class="" ng-click="click_item(<?php echo e($room->image); ?>)">
							<figure>
								<div class="overlay"><i class="ti-plus"></i></div>
								<img src="<?php echo e($room->image[0]->path); ?>" alt="Image" class="img-responsive">
							</figure>
							<div class="fh5co-text">
								<h2><?php echo e($room->name); ?></h2>
								<p class="desc-menu"><?php echo e($room->description); ?></p>
								<p><span class="price cursive-font"><?php echo e($room->price); ?> บาท</span></p>
							</div>
						</a>
						<button class="btn btn-info btn-block" ng-click="reservation(<?php echo e($room); ?>)">ทำการจอง</button>
					</div>
				</div>
				<?php endforeach; ?>
			</div>
