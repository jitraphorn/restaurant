<aside>
  <div id="sidebar" class="nav-collapse">
    ...
    <ul class="sidebar-menu">
      <li class="menu-title">ข้อมูลการดำเนินการ</li>
      <li id="dashboard-menu"><a href="/admin/dashboard"><i class="fa fa-home"></i><span>หน้าแรก</span></a></li>
      <li id="order-menu"><a href="/admin/order"><i class="icon-chair"></i><span>การจองโต๊ะอาหาร</span></a></li>
      <li id="books-menu"><a href="/admin/books"><i class="icon-book3"></i><span>การจองห้องพัก</span></a></li>
