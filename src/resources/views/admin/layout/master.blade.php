...
<head>
  ...
  <!-- full calendar css-->
  <link href="{!! asset('assets/backend/fullcalendar/fullcalendar/bootstrap-fullcalendar.css') !!}" rel="stylesheet" />
  <link href="{!! asset('assets/backend/fullcalendar/fullcalendar/fullcalendar.css') !!}" rel="stylesheet" />
  <!-- easy pie chart-->
  <link href="{!! asset('assets/backend/jquery-easy-pie-chart/jquery.easy-pie-chart.css') !!}" rel="stylesheet" type="text/css" media="screen"/>
  <!-- owl carousel -->
...
<script src="{!! asset('assets/backend/js/jquery-ui-1.10.4.min.js') !!}"></script>
<script src="{!! asset('assets/backend/js/jquery-1.8.3.min.js') !!}"></script>
<script type="text/javascript" src="{!! asset('assets/backend/js/jquery-ui-1.9.2.custom.min.js') !!}"></script>
...
<!-- charts scripts -->
<script src="{!! asset('assets/backend/jquery-knob/js/jquery.knob.js') !!}"></script>
<script src="{!! asset('assets/backend/js/jquery.sparkline.js') !!}" type="text/javascript"></script>
<script src="{!! asset('assets/backend/jquery-easy-pie-chart/jquery.easy-pie-chart.js') !!}"></script>
...
<script src="{!! asset('assets/backend/js/jquery.rateit.min.js') !!}"></script>
<!-- custom select -->
<script src="{!! asset('assets/backend/js/jquery.customSelect.min.js') !!}" ></script>
<script src="{!! asset('assets/backend/chart-master/Chart.js') !!}"></script>
...
<script src="{!! asset('assets/backend/js/jquery-jvectormap-1.2.2.min.js') !!}"></script>
<script src="{!! asset('assets/backend/js/jquery-jvectormap-world-mill-en.js') !!}"></script>
<script src="{!! asset('assets/backend/js/xcharts.min.js') !!}"></script>
<script src="{!! asset('assets/backend/js/jquery.autosize.min.js') !!}"></script>
<script src="{!! asset('assets/backend/js/jquery.placeholder.min.js') !!}"></script>
<script src="{!! asset('assets/backend/js/gdp-data.js') !!}"></script>	
